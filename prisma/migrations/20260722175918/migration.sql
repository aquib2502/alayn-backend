...
-- AlterEnum
BEGIN;
CREATE TYPE "OrderStatus_new" AS ENUM ('SENT_TO_KITCHEN', 'PREPARING', 'READY', 'SERVED', 'DISPATCHED', 'COMPLETED', 'CANCELLED');
...
ALTER TABLE "Order" ALTER COLUMN "status" SET DEFAULT 'SENT_TO_KITCHEN';
COMMIT;
